...
export class HomePage {
    ...
    async isTostVisible(){
      ...
      async addCart(){
      await this.page.locator("//a[contains(text(),'View Cart')]").click();
      await expect(this.page).toHaveURL(/.*cart/); 
      }

      async checkOut(){
        await this.page.locator("//a[contains(text(),'Checkout')]").click();
      ...
      async fillBillingAddress(){
        ...
        await this.page.locator(this.billingAddressLocators.country).selectOption('India');
        await this.page.locator(this.billingAddressLocators.region).selectOption('Karnataka');
